...
train_model(n_estimators=50, max_depth=5, random_state=39644481)
"
...
python -c "
from src.train_mlflow import train_model
train_model(n_estimators=100, max_depth=10, random_state=39644481)
"
...
python -c "
from src.train_mlflow import train_model
train_model(n_estimators=150, max_depth=None, random_state=39644481)
"
